package com.news.soft.backchina.emoji;
...
import com.news.soft.backchina.utils.DisplayUtil;
...
//        Integer res = DisplayRules.getMapAll().get(name);
    ...
    public static Spannable displayEmoji(Resources res, Spannable spannable){
        ...
        while (matcher.find()){
            ...
            drawable.setBounds(0, 0, (int) DisplayUtil.dip2px(20), (int) DisplayUtil.dip2px(20));
