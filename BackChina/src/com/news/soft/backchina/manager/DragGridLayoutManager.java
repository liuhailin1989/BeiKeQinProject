package com.news.soft.backchina.manager;
...
public class DragGridLayoutManager extends GridLayoutManager {
    ...
    private void measureChild(RecyclerView.Recycler recycler, int position, int widthSize, int heightSize, int[] dimensions) {
        ...
        try {
            ...
            TLog.e("LinearLayoutManager doesn't work well with animations. Consider switching them off", e);
            return;
        }
    ...
    private static void onMakeInsertDirtyFailed() {
        ...
        TLog.w("Can't make LayoutParams insets dirty, decorations measurements might be incorrect");
    }

    private void logMeasureWarning(int child) {
        TLog.w("Can't measure child #" + child + ", previously used dimensions will be reused." +
